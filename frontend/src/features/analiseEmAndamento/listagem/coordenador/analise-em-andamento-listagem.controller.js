var AnaliseEmAndamentoCoordenadorListController = function($scope, config, $location, $rootScope, processoService) {
...
exports.controllers.AnaliseEmAndamentoCoordenadorListController = AnaliseEmAndamentoCoordenadorListController;