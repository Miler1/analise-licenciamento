var CxEntCoordenadorGeoController = function($scope, config, analistaService,analiseTecnicaService, mensagem, $uibModal,$rootScope, processoService, analiseGeoService, $location) {

	$rootScope.tituloPagina = 'AGUARDANDO VALIDAÇÃO DO COORDENADOR GEO';
...
exports.controllers.CxEntCoordenadorGeoController = CxEntCoordenadorGeoController;