...
GRANT SELECT, UPDATE, INSERT, DELETE ON TABLE analise.gerente_tecnico TO licenciamento_pa;
GRANT SELECT, USAGE ON SEQUENCE analise.gerente_tecnico_id_seq TO licenciamento_pa;
