...
@Entity
@Table(schema = "analise", name = "parecer_secretario")
public class ParecerSecretario extends GenericModel {

    public static final String SEQ = "analise.parecer_secretario_id_seq";
    ...
    @JoinColumn(name = "id_usuario_secretario", referencedColumnName = "id")
    ...
    public static ParecerSecretario getUltimoParecerSecretario(List<ParecerSecretario> pareceresSecretario) {

        return pareceresSecretario.stream().max(Comparator.comparing(ParecerSecretario::getDataParecer)).orElseThrow(ValidationException::new);

    }

    public void finalizar(Analise analise, UsuarioAnalise secretario) throws Exception {
