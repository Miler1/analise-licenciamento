...
public enum PDFTemplate {
    ...
    PARECER_ANALISE_GEO (TipoDocumento.PARECER_ANALISE_GEO),
    ...
    DOCUMENTO_OFICIO_ORGAO (TipoDocumento.DOCUMENTO_OFICIO_ORGAO),
    DOCUMENTO_RELATORIO_TECNICO_VISTORIA (TipoDocumento.DOCUMENTO_RELATORIO_TECNICO_VISTORIA),
    DOCUMENTO_MINUTA (TipoDocumento.DOCUMENTO_MINUTA);
