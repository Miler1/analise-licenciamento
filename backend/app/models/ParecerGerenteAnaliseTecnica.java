...
@Entity
@Table(schema = "analise", name = "parecer_gerente_analise_tecnica")
public class ParecerGerenteAnaliseTecnica extends GenericModel {

	public static final String SEQ = "analise.parecer_gerente_analise_tecnica_id_seq";
	...
	public void finalizar(AnaliseTecnica analiseTecnica, UsuarioAnalise gerente) {
		...
		if (this.tipoResultadoAnalise.id.equals(TipoResultadoAnalise.PARECER_VALIDADO)) {
			...
			analiseTecnica.analise.processo.tramitacao.tramitar(analiseTecnica.analise.processo, AcaoTramitacao.SOLICITAR_AJUSTES_PARECER_TECNICO_PELO_GERENTE, getUsuarioSessao(), analistaTecnico);
			HistoricoTramitacao.setSetor(HistoricoTramitacao.getUltimaTramitacao(analiseTecnica.analise.processo.objetoTramitavel.id), getUsuarioSessao());
