...
public class EmailNotificacaoStatusAnalise extends EmailNotificacao {
    ...
    public void enviar() {
        ...
        try {
            ...
            main.java.br.ufla.lemaf.beans.Empreendimento empreendimentoEU = integracaoEntradaUnica.findEmpreendimentosByCpfCnpj(analise.processo.empreendimento.getCpfCnpj());
