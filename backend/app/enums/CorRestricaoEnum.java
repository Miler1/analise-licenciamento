...
public enum CorRestricaoEnum {
    ...
    UC_MUNICIPAL("Unidade de conservação municipal", Color.decode("#57489c")),
    TERRA_INDIGENA_ZA("Terra indígena ZA", Color.decode("#996d6d")),
    TERRA_INDIGENA_ESTUDO("Terra indígena estudo", Color.decode("#FF1300")),
    UC_FEDERAL_APA_DENTRO("Unidade de conservação dentro APA", Color.decode("#9c9648")),
    UC_FEDERAL_APA_FORA("Unidade de conservação fora APA", Color.decode("#9c7648")),
    UC_FEDERAL_ZA("Unidade de conservação federal ZA", Color.decode("#9c4848")),
