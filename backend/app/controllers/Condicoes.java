...
public class Condicoes extends InternalController {
	...
	public static void list() {
		...
		List<Condicao> condicoesVisiveis = Condicao.find("idCondicao in (:idsCondicoes)")
				.setParameter("idsCondicoes", Arrays.asList(Condicao.AGUARDANDO_ANALISE_GEO, Condicao.EM_ANALISE_GEO, Condicao.SOLICITACAO_DESVINCULO_PENDENTE, Condicao.NOTIFICADO, Condicao.AGUARDANDO_VALIDACAO_GEO_PELO_GERENTE))
				.fetch();
