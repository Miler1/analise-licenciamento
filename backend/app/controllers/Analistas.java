...
public class Analistas extends InternalController {
	...
	public static void getAnalistaTecnico(Long idProcesso) {
		...
		List<Usuario> consultores = Usuario.getUsuariosByPerfilSetor(Perfil.ANALISTA_TECNICO,processo.caracterizacoes.get(0).atividadeCaracterizacao.atividadeCnae.setor.id);
