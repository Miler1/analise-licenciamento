...
public class NumeroExtenso {
	...
	private String trioextenso[][] = {
			{ "dummy", "um", "dois", "três", "quatro", "cinco", "seis", "sete", "oito", "nove" },
			{ "dez", "onze", "doze", "treze", "quatorze", "quinze", "dezesseis", "dezessete", "dezoito", "dezenove" },
			{ "dummy", "dummy", "vinte", "trinta", "quarenta", "cinquenta", "sessenta", "setenta", "oitenta",
					"noventa" },
			{ "dummy", "cento", "duzentos", "trezentos", "quatrocentos", "quinhentos", "seiscentos", "setecentos",
					"oitocentos", "novecentos" } };

	private String classextenso[] = { "dummy", "mil", "milh", "bilh", "trilh", "quatrilh", "quintilh", "sextilh",
			"septilh", "octilh", "nonilh", "decilh", "undecilh", "duodecilh", "tredecilh", "quatordecilh", "quindecilh",
			"sexdecilh", "setedecilh", "octodecilh", "novedecilh", "vigesilh" };
	...
	/*
	 * Recebe um trio da forma cdu e o transforma em extenso.
	 */
	public String escrever_trio_extenso(String trio) {
		...
		if (trio.equals("100"))
			...
			if (c != '0')
				saida = trioextenso[3][c - '0'];
			if (d == '1')
				saida = saida + " " + trioextenso[1][u - '0'];
			else {
				if (d != '0')
					saida = saida + " " + trioextenso[2][d - '0'];
				if (u != '0')
					saida = saida + " " + trioextenso[0][u - '0'];
			}
		}
	...
	/*
	 * Retorna um vetor de Strings sendo cada elemento um trio. A ordem dos trios
	 * está inversa em relação ao original.
	 */
	...
	public String getExtenso(String numero) {
		...
		/*
		 * Padding: Garante que a quantidade de alg. do número seja multipla de três.
		 */
		t = numero.length() % 3;
		if (t == 1) {
			numero = "00" + numero;
