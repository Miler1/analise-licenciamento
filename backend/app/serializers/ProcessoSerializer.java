...
public class ProcessoSerializer {
	...
	public static JSONSerializer getInfo = SerializerUtil.create(
			...
			"analises.analisesJuridica.dataInicio",
			"analises.analisesJuridica.dataFim",
			"analises.analisesGeo.dataVencimentoPrazo",
			"analises.analisesGeo.dataInicio",
			"analises.analisesGeo.dataFim",
			"analises.analisesTecnica.dataCadastro",
			"analises.analisesTecnica.justificativaCoordenador",
			"analises.analisesTecnica.dataFim",
			"analises.analisesTecnica.dataVencimentoPrazo",
			...
			"caracterizacoes.licencas.dataValidade",
			...
			"caracterizacoes.atividadesCaracterizacao.atividade.potencialPoluidor.codigo",
			"caracterizacoes.atividadesCaracterizacao.atividade.nome",
			"caracterizacoes.atividadesCaracterizacao.atividade.tipologia.nome",
			"caracterizacoes.atividadesCaracterizacao.atividadesCnae",
			"caracterizacoes.atividadesCaracterizacao.atividadesCnae.nome",
			"caracterizacoes.atividadesCaracterizacao.atividadesCnae.codigo",
			"caracterizacoes.atividadesCaracterizacao.atividadeCaracterizacaoParametros.valorParametro",
			"caracterizacoes.atividadesCaracterizacao.porteEmpreendimento.codigo",
			"caracterizacoes.atividadesCaracterizacao.porteEmpreendimento.nome",
			"caracterizacoes.atividadesCaracterizacao.atividade.parametros.nome",
			"caracterizacoes.atividadesCaracterizacao.atividade.parametros.codigo")
