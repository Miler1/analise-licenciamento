...
public class CamadaGeoAtividadeSerializer {
	...
	public static JSONSerializer getDadosProjeto = SerializerUtil.create(
			...
			"restricoes.sobreposicaoCaracterizacaoComplexto.id",
			"restricoes.sobreposicaoCaracterizacaoComplexto.tipoSobreposicao.id",
			"restricoes.sobreposicaoCaracterizacaoComplexto.tipoSobreposicao.orgaosResponsaveis",
			"restricoes.sobreposicaoCaracterizacaoComplexto.tipoSobreposicao.orgaosResponsaveis.sigla",
			"restricoes.sobreposicaoCaracterizacaoComplexto.tipoSobreposicao.codigo",
